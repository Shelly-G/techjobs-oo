...
public class JobController {
    ...
    public String add(Model model, @Valid JobForm jobForm, Errors errors, RedirectAttributes attributes) {
        ...
        CoreCompetency jobCompetencies = jobData.getCoreCompetencies().findById(jobForm.getCoreCompetenciesId());

        Job newJob = new Job(jobName, jobEmployer, jobLocation,jobPosition, jobCompetencies);
